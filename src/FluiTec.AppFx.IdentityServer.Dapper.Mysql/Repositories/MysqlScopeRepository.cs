...
{
    /// <summary>	A Mysql scope repository. </summary>
    public class MysqlScopeRepository : ScopeRepository
    {
        #region Constructors

        /// <summary>	Constructor. </summary>
        /// <param name="unitOfWork">	The unit of work. </param>
        public MysqlScopeRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
