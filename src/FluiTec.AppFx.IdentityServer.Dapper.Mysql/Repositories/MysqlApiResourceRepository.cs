...
{
    /// <summary>	A Mysql API resource repository. </summary>
    public class MysqlApiResourceRepository : ApiResourceRepository
    {
        #region Constructors

        /// <summary>	Constructor. </summary>
        /// <param name="unitOfWork">	The unit of work. </param>
        public MysqlApiResourceRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        {
            var command =
                $"SELECT {SqlBuilder.Adapter.RenderPropertyList(SqlCache.TypePropertiesChache(typeof(ApiResourceEntity)).ToArray())} FROM {TableName} WHERE {nameof(ApiResourceEntity.Id)} IN @Ids";
