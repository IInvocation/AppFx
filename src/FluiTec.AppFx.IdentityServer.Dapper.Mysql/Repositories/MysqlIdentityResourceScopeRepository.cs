...
{
    /// <summary>	A mysql identity resource scope repository. </summary>
    public class MysqlIdentityResourceScopeRepository : IdentityResourceScopeRepository
    {
        /// <summary>	Constructor. </summary>
        /// <param name="unitOfWork">	The unit of work. </param>
        public MysqlIdentityResourceScopeRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
