...
{
    /// <summary>
    ///     A lite database identity server unit of work.
    /// </summary>
    public class LiteDbIdentityServerUnitOfWork : LiteDbUnitOfWork, IIdentityServerUnitOfWork
    {
        #region Constructors
        ...
        public LiteDbIdentityServerUnitOfWork(LiteDbDataService dataService) : base(dataService)
        {
        }
        ...
        public LiteDbIdentityServerUnitOfWork(LiteDbDataService dataService, LiteDbUnitOfWork parentUnitOfWork) : base(
        ...
        public IScopeRepository ScopeRepository =>
            _scopeRepository ?? (_scopeRepository = GetRepository<IScopeRepository>());
