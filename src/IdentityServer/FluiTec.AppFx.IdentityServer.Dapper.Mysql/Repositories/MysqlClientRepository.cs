...
{
    /// <summary>	A Mysql client repository. </summary>
    public class MysqlClientRepository : ClientRepository
    {
        #region Constructors

        /// <summary>	Constructor. </summary>
        /// <param name="unitOfWork">	The unit of work. </param>
        public MysqlClientRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
