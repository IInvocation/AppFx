...
{
    /// <summary>	A Mysql identity resource repository. </summary>
    public class MysqlIdentityResourceRepository : IdentityResourceRepository
    {
        #region Constructors

        /// <summary>	Constructor. </summary>
        /// <param name="unitOfWork">	The unit of work. </param>
        public MysqlIdentityResourceRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
