...
{
    /// <summary>	A Mysql grant repository. </summary>
    public class MysqlGrantRepository : GrantRepository
    {
        #region Constructors

        /// <summary>	Constructor. </summary>
        /// <param name="unitOfWork">	The unit of work. </param>
        public MysqlGrantRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
