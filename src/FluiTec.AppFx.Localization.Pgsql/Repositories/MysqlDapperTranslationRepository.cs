...
{
    /// <summary>A mysql dapper translation repository.</summary>
    public class PgsqlDapperTranslationRepository : TranslationRepository, ITranslationRepository
    {
        /// <summary>Constructor.</summary>
        /// <param name="work"> The work. </param>
        public PgsqlDapperTranslationRepository(IUnitOfWork work) : base(work)
        {
        }
