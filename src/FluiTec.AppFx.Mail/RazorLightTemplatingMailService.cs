...
namespace FluiTec.AppFx.Mail
{
	...
	public abstract class RazorLightTemplatingMailService : ITemplatingMailService
	{
		...
		protected RazorLightTemplatingMailService(IRazorLightEngine engine)
		{
		...
		protected RazorLightTemplatingMailService(string viewPath)
		{
