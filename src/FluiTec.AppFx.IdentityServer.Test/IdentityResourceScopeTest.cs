    ...
    public class IdentityResourceScopeTest : IdentityServerTest
    {
	    ...
	    public virtual void CanAddAndGetIdentityResourceScope()
	    {
		    using (var uow = DataService.StartUnitOfWork())
		    {
			    ...
			    Assert.AreEqual(resourceScope.IdentityResourceId, uow.IdentityResourceScopeRepository.Get(resourceScope.Id).IdentityResourceId);
		    }
	    }
	    ...
	    public virtual void CanUpdateIdentityResourceScope()
	    {
		    using (var uow = DataService.StartUnitOfWork())
		    {
			    ...
			    Assert.AreEqual(resourceScope.ScopeId, uow.IdentityResourceScopeRepository.Get(resourceScope.Id).ScopeId);
		    }
	    }
	    ...
	    public virtual void CanDeleteIdentityResourceScope()
	    {
		    using (var uow = DataService.StartUnitOfWork())
		    {
			    ...
			    Assert.AreEqual(expected: null, actual: uow.IdentityResourceScopeRepository.Get(resourceScope.Id));
		    }
	    }
	}
}
