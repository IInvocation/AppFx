...
namespace FluiTec.AppFx.Localization
{
    ...
    public class DbHtmlLocalizer : IViewLocalizer
    {
        ...
        /// <summary>Gets the string resource with the given name and formatted with the supplied
        /// arguments.</summary>
        /// <param name="name">         The name of the string resource. </param>
        ...
        /// <summary>Creates a new <see cref="T:Microsoft.AspNetCore.Mvc.Localization.IHtmlLocalizer" />
        /// for a specific <see cref="T:System.Globalization.CultureInfo" />.</summary>
        /// <param name="culture">  The <see cref="T:System.Globalization.CultureInfo" /> to use. </param>
        /// <returns>A culture-specific
        /// <see cref="T:Microsoft.AspNetCore.Mvc.Localization.IHtmlLocalizer" />.</returns>
        ...
        /// <param name="name"> The name of the string resource. </param>
        /// <returns>The string resource as a
        /// <see cref="T:Microsoft.AspNetCore.Mvc.Localization.LocalizedHtmlString" />.</returns>
