...
namespace FluiTec.AppFx.AspNetCore.Examples.LocalizationExample.Resources
{
    ...
    public class Resource
    {
        ...
        public static string StaticProperty => "StaticProperty-Value"; // this defines localization for cultures: invariant, en
        ...
        public string RefactoredProperty => "RefactoredProperty-Value"; // this defines localization for cultures: invariant, en
    }
}