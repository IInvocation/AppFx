...
namespace FluiTec.AppFx.AspNetCore.Examples.LocalizationExample.Models
{
    ...
    public class AnnotationModel : ConfirmEmailAgainViewModel
    {
        ...
        private const string FullModelName = "FluiTec.AppFx.AspNetCore.Examples.LocalizationExample.Models.AnnotationModel";

        /// <summary>   Gets or sets the name of the user. </summary>
        /// <value> The name of the user. </value>
        [Display(Name = FullModelName + "UserName", Description = "Username:")] // translation for cultures: invariant, en
