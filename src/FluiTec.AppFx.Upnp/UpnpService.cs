    ...
    public class UpnpService
    {
        ...
        public async Task RemovePortMapping(int privatePort, IPAddress ipAddress = null)
        {
            try
            {
                ...
                if (mapping != null)
                    await device.DeletePortMapAsync(new Mapping(Protocol.Tcp,
                        IPAddress.Parse(mapping.PrivatecIpAddress),
        ...
        public async Task<PortMapping> AddPortMapping(string applicationName, int privatePort,
            IPAddress ipAddress = null)
        {
            try
            {
                ...
                await device.CreatePortMapAsync(new Mapping(Protocol.Tcp, ipAddress, privatePort, maxPortPublic + 1,
                    int.MaxValue,
