...
{
	/// <summary>	A pgsql dapper user role repository. </summary>
	public class PgsqlDapperUserRoleRepository : DapperUserRoleRepository
	{
		/// <summary>	Constructor. </summary>
		/// <param name="unitOfWork">	The unit of work. </param>
		public PgsqlDapperUserRoleRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
		{
		}
