...
{
	/// <summary>	A pgsql dapper claim repository. </summary>
	public class PgsqlDapperClaimRepository : DapperClaimRepository
	{
		/// <summary>	Constructor. </summary>
		/// <param name="unitOfWork">	The unit of work. </param>
		public PgsqlDapperClaimRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
		{
		}
