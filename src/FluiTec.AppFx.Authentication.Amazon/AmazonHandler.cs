...
namespace FluiTec.AppFx.Authentication.Amazon
{
	...
	internal class AmazonHandler : OAuthHandler<AmazonOptions>
	{
		...
		public AmazonHandler(IOptionsMonitor<AmazonOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock) : base(options, logger, encoder, clock)
		{
		}
