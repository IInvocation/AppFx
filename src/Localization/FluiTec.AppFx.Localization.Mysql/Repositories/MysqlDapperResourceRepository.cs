...
namespace FluiTec.AppFx.Localization.Mysql.Repositories
{
    /// <summary>A mysql dapper resource repository.</summary>
    public class MysqlDapperResourceRepository : ResourceRepository, IResourceRepository
    {
        /// <summary>Constructor.</summary>
        /// <param name="work"> The work. </param>
        public MysqlDapperResourceRepository(IUnitOfWork work) : base(work)
        {
        }
