...
{
    /// <summary>A policy names.</summary>
    public class PolicyNames
    {
        ...
        /// <summary>The users create.</summary>
        public const string UsersCreate = "UsersCreate";

        /// <summary>The users update.</summary>
        ...
        /// <summary>The roles create.</summary>
        public const string RolesCreate = "RolesCreate";

        /// <summary>The roles update.</summary>
        ...
        /// <summary>   The ClientClaims create. </summary>
        public const string ClientClaimsCreate = "ClientClaimsCreate";

        /// <summary>   The ClientClaims update. </summary>
        public const string ClientClaimsUpdate = "ClientClaimsUpdate";
