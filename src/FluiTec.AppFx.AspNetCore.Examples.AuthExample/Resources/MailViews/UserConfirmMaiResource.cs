...
namespace FluiTec.AppFx.AspNetCore.Examples.AuthExample.Resources.MailViews
{
    ...
    public class UserConfirmMailResource
    {
        ...
        public static string PleaeConfirmText => "Hello, <br /><br />please confirm your mail-address by opening the following link:";
        ...
        [TranslationForCulture("Sie erhalten diese Nachricht, da jemand versucht hat einen Account auf <a href=\"{0}\">{1}</a> zu erstellen.", "de")]
        public static string ConfirmEmailReasonText => "You're receiving this message, as somebody tried creating an account on <a href=\"{0}\">{1}</a>.";
