...
namespace FluiTec.AppFx.Data.Sql.Test
{
	...
	public class PgsqlBuilderTest
	{
		...
		public void TestSelectAll()
		{
			...
			Assert.AreEqual($"SELECT * FROM \"public\".\"{nameof(Dummy)}\"", sql);
		}
		...
		public void TestSelectByKey()
		{
			...
			Assert.AreEqual($"SELECT * FROM \"public\".\"{nameof(Dummy)}\" WHERE \"Id\" = @Id", sql);
		}
		...
		public void TestInsertAutoKey()
		{
			...
			Assert.AreEqual($"INSERT INTO \"public\".\"{nameof(Dummy)}\" (\"Name\") VALUES (@Name) RETURNING \"{nameof(Dummy.Id)}\"", sql);
		}
