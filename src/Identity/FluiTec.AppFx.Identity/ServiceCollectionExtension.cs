    ...
    public static class ServiceCollectionExtension
    {
        ...
        public static IServiceCollection AddIdentityStores(this IServiceCollection services)
        {
            ...
            services.AddScoped<IUserPasswordStore<IdentityUserEntity>>(provider =>
                provider.GetService<IdentityStore>());
            services.AddScoped<IUserSecurityStampStore<IdentityUserEntity>>(provider =>
                provider.GetService<IdentityStore>());
            ...
            services.AddScoped<IUserPhoneNumberStore<IdentityUserEntity>>(provider =>
                provider.GetService<IdentityStore>());
            services.AddScoped<IUserTwoFactorStore<IdentityUserEntity>>(
                provider => provider.GetService<IdentityStore>());
